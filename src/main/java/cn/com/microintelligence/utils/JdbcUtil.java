...
public class JdbcUtil implements Serializable{
    private static String table_name = "ads_product_report";
    private static String table_name_defect = "ads_product_defect_analyze";

    public static ProductReportRs checkDataAndGetValue(Statement stmt, DwsProductAccepted dwsProductAccepted, String date, String dh) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductAccepted.getProduct_id()+dwsProductAccepted.getProduction_line_id()+
                ...
                date+dh+dwsProductAccepted.getCustomer_id());
    ...
    public static void updateDwsProductAccepted(Statement stmt, ProductReportRs reportRs, DwsProductAccepted dwsProductAccepted, String date, String dh,String time) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductAccepted.getProduct_id()+dwsProductAccepted.getProduction_line_id()+
                dwsProductAccepted.getProcess_id()+dwsProductAccepted.getBatch_no()+dwsProductAccepted.getShift_id()+
                date+dh+dwsProductAccepted.getCustomer_id());
    ...
    public static void insertDwsProductAccepted(Statement stmt, DwsProductAccepted dwsProductAccepted, String date,
                                         String year, String month, String dt, String dh,String time) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductAccepted.getProduct_id()+dwsProductAccepted.getProduction_line_id()+
                dwsProductAccepted.getProcess_id()+dwsProductAccepted.getBatch_no()+dwsProductAccepted.getShift_id()+
                date+dh+dwsProductAccepted.getCustomer_id());
        String sql = "insert into "  + table_name + " ( i_business_id,i_product_id,i_product_name, i_production_line_id, i_production_line_name,i_process_id, i_process_name,i_batch_id,i_shift_id, i_shift_name,year, month, day, hour, date, " +
    ...
    public static ProductReportRs checkDataAndGetValue(Statement stmt, DwsProductRejects dwsProductRejects, String date, String dh) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductRejects.getProduct_id()+dwsProductRejects.getProduction_line_id()+
                ...
                date+dh+dwsProductRejects.getCustomer_id());
        ProductReportRs reportRs = new ProductReportRs();
        String sql = "select i_good_product_num,i_rework_num,i_scrap_num,i_product_num from " + table_name +
    ...
    public static void updateDwsProductRejects(Statement stmt, ProductReportRs reportRs, DwsProductRejects dwsProductRejects, String date, String dh,String time) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductRejects.getProduct_id()+dwsProductRejects.getProduction_line_id()+
                dwsProductRejects.getProcess_id()+dwsProductRejects.getBatch_no()+dwsProductRejects.getShift_id()+
                date+dh+dwsProductRejects.getCustomer_id());
    ...
    public static void insertDwsProductRejects(Statement stmt, DwsProductRejects dwsProductRejects, String date,
                                        String year, String month, String dt, String dh,String time) throws SQLException {
        long i_scrap_num = 0;
        long i_rework_num = 0;
        if("1".equals(dwsProductRejects.getProduct_grade_level())){
    ...
    public static ProductDefectRs checkDataAndGetValueDefect(Statement stmt, DwsProductDefect dwsProductDefect, String date, String dh) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductDefect.getProduct_id()+ dwsProductDefect.getProduction_line_id()+
                ...
                date+dh+dwsProductDefect.getProduct_grade_code()+dwsProductDefect.getCustomer_id());
    ...
    public static void updateDwsProductDefect(Statement stmt, ProductDefectRs reportRs, DwsProductDefect dwsProductDefect, String date, String dh,String time) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductDefect.getProduct_id()+ dwsProductDefect.getProduction_line_id()+
                dwsProductDefect.getProcess_id()+dwsProductDefect.getBatch_no()+dwsProductDefect.getShift_id()+
                date+dh+dwsProductDefect.getProduct_grade_code()+dwsProductDefect.getCustomer_id());
    ...
    public static void insertDwsProductDefect(Statement stmt, DwsProductDefect dwsProductDefect, String date,
                                       String year, String month, String dt, String dh,String time) throws SQLException {
        String md5 = DigestUtils.md5Hex(dwsProductDefect.getProduct_id()+ dwsProductDefect.getProduction_line_id()+
                dwsProductDefect.getProcess_id()+dwsProductDefect.getBatch_no()+dwsProductDefect.getShift_id()+
                date+dh+dwsProductDefect.getProduct_grade_code()+dwsProductDefect.getCustomer_id());
        String sql = "insert into " + table_name_defect + " (i_business_id,i_product_id,i_product_name,i_production_line_id,i_production_line_name,i_process_id,i_process_name,i_batch_id,i_shift_id,i_shift_name," +
                "year,month,day,hour,date,dt_detection_date_time,i_product_defect_id,i_product_defect_name,i_defect_fqs,i_customer_id,md5_index) values ( " +
                "'" + IdWorker.getId() + "', " +
