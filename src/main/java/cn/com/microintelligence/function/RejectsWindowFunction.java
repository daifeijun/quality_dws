...
public class RejectsWindowFunction implements WindowFunction<DwsProductRejects, DwsProductRejects, Tuple, TimeWindow> {

    @Override
    public void apply(Tuple tuple, TimeWindow timeWindow, Iterable<DwsProductRejects> iterable, Collector<DwsProductRejects> collector) throws Exception {
        //得到检测时间 格式为 年-月-日 时
        ...
        collector.collect(new DwsProductRejects(tuple.getField(0),tuple.getField(1),
                tuple.getField(2),tuple.getField(3),tuple.getField(4),tuple.getField(5),
                tuple.getField(6),tuple.getField(7),tuple.getField(8),
                "",time,tuple.getField(10),tuple.getField(11),String.valueOf(sum),tuple.getField(12),tuple.getField(13),
                "","dws_product_rejects"
        ));
    }
}
